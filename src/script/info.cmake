...
#     somewhere in the main CMakeLists file a call to the 'indexResources' function should be made.
# 
# 
#    To add bundle to the executable or library a call to the 'assignBundle' function should
#     be made. Function accepts two arguments which are CMake target and a bundle name:
# 
...
# 
#    Here 'R' is the bundle resources root, <category_name> is name of sub-folder in the bundle
#     directory. If file is nested more than one sub-folder deep, several <category_name>'s
#     must be referenced by '.' before file can be referenced. Consider following example:
# 
#         <bundle_directory>
#         |- file_1
#         |- folder_1
